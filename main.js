...
/* ═══ FORM ═══ */
function submitForm(){
  var n=document.getElementById('fn').value,e=document.getElementById('fe').value;
  if(!n||!e){alert({en:'Please fill in all required fields.',de:'Bitte füllen Sie alle Pflichtfelder aus.',fr:'Veuillez remplir tous les champs obligatoires.'}[lang]);return;}
  alert({en:'Thank you! We will be in touch within 24 hours.',de:'Vielen Dank! Wir melden uns innerhalb von 24 Stunden.',fr:'Merci ! Nous vous contacterons dans les 24 heures.'}[lang]);
}
